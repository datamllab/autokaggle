...
Notably, you can follow the tag of [call for contributors](https://github.com/datamllab/autokaggle/labels/call%20for%20contributors) in the issues.
...
#### Submit Feedback
The feedback should be submitted by creating an issue at [GitHub issues](https://github.com/datamllab/autokaggle/issues).
Select the related template (bug report, feature request, or custom) and add the corresponding labels.

#### Fix Bugs:
You may look through the [GitHub issues](https://github.com/datamllab/autokaggle/issues) for bugs.
...
#### Implement Features
You may look through the [GitHub issues](https://github.com/datamllab/autokaggle/issues) for feature requests.
...
[Documentation Guide](#documentation-guide),
and
[Testing Guide](https://github.com/datamllab/autokaggle/blob/master/CONTRIBUTING.md#testing-guide)
to ensure your merge request meet our requirements.

#### Write Documentation
The documentation of Auto-Keras is either directly written into the Markdown files in
[mkdocs directory](https://github.com/datamllab/autokaggle/tree/master/mkdocs/docs),
or automatically extracted from the docstrings by executing the [autogen.py](https://github.com/datamllab/autokaggle/blob/master/mkdocs/autogen.py).
In the first situation, you only need to change the markdown file.
In the second situation, you need to change the docstrings and execute [autogen.py](https://github.com/datamllab/autokaggle/blob/master/mkdocs/autogen.py) to update the Markdown files.
Please follow the 
[Pull Request Guide](#pull-request-guide) to submit your pull request. 
Please also read
[Documentation Guide](#documentation-guide)
...
2. Pull request from your new branch to the master branch of the original autokaggle repo. Give your pull request a **meaningful** name.
...
We recommend you to create a virtualenv for autokaggle development with virtualenvwrapper,
and only install the packages required by autokaggle with the corresponding version.
